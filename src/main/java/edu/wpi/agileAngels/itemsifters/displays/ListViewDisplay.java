...
/**
 * help me improve this class to make it more useful: nllopez@wpi.edu needs stuff that interacts
 * with list view's actual cell factory
 */
public class ListViewDisplay<T, Cell> implements IDisplay<T> {
   ...
   * with whatever event handlers we need attached to it. We can define this function in whatever
   * scope we want, as long as we put it in here.
   */
