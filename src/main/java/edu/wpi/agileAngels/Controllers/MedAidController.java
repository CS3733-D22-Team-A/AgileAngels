...
public class MedAidController implements Initializable {
  ...
  private void displayIcon(String treatment, int iconNum) {
    ...
    Image im1 =
        new Image(
            "https://www.pinclipart.com/picdir/middle/523-5239855_pill-clipart-svg-pills-icon-png-transparent-png.png");
    // bed
    Image im2 = new Image("http://simpleicon.com/wp-content/uploads/rest.png");
    // Hydration
    Image im3 =
        new Image(
            "https://png.pngtree.com/png-vector/20190328/ourlarge/pngtree-vector-water-bottle-icon-png-image_872119.jpg");
    // Surgery
