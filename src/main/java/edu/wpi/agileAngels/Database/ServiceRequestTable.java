...
public class ServiceRequestTable implements TableI {
    ...
    public boolean add(Object obj) {
        try{
            ...
            String add = "INSERT INTO ServiceRequests(Name, EmployeeName, Location, Type, Status, Description, Attribute1, Attribute2) VALUES(?,?,?,?,?,?,?,?)";
    ...
    public boolean update(Object obj) {
        try{
            ...
            Request request = (Request) obj;
            String update = "UPDATE ServiceRequests SET EmployeeName = ?, Location = ?, Type = ?, Status = ?, Description = ?, Attribute1 = ?, Attribute2 = ? WHERE Name = ?";
