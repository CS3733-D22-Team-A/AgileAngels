...
public class MedDAOImpl implements MedDAO {
  ...
  private final String CSV_FILE_PATH = "./new.csv";
  ...
  public void updateName(MedDevice medDevice, String newName) {
    ...
    System.out.println("Medical Equipment: Name " + medDevice.getName() + ", updated in the database");
  }
  ...
  public void deleteMed(MedDevice medDevice) {
    ...
    System.out.println("Medical Equipment: Name " + medDevice.getName() + ", deleted in the database");
  ...
  public void addMed(MedDevice medDevice) {
    ...
    System.out.println("Medical Equipment: Name " + medDevice.getName() + ", added in the database");
