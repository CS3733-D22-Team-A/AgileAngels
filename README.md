...
To see the pages and our final presentation: https://www.canva.com/design/DAE-qHZb3Ug/l82-8KbAacjzxblDifr1Qg/edit?utm_content=DAE-qHZb3Ug&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton
...
This is the gradle configuration file. Modify this file to add dependencies to your project. In
 general you should only modify the depedencies section of this file, however there are a few
  ...
  - `mainClassName`
    - Modifiy this variable to point to your main class. By default it is `edu.wpi.agileAngels.Main
